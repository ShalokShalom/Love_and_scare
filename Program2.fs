...
type Status = Status of string

type Humility = Humility of string
type Confidence = Confidence of string
type Unity = Unity of string 
type Integrity = Integrity of string
type Trust = Trust of string
type Kindness = Kindness of string 
type Sympathy = Sympathy of string
type Openness = Openness of string 
type Simplicity = Simplicity of string 
type Acceptance = Acceptance of string

type Need = Need of string
type Failure = Failure of string
type Disunity = Disunity of string
type Insufficiency = Insufficiency of string
type Requirement = Requirement of string
type Judgment = Judgment of string 
type Condemnation = Condemnation of string
type Conditionality = Conditionality of string
type Superiority = Superiority of string 
type Ignorance = Ignorance of string
